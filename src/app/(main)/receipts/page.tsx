import { MoreHorizontal, PlusCircle, Warehouse } from "lucide-react";
        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="font-headline">Receipts (Incoming Stock)</CardTitle>
            </div>
            <CardDescription>Track goods arriving from vendors.</CardDescription>
          </div>
          <Button size="sm" className="gap-1">
            <PlusCircle className="h-3.5 w-3.5" />
            <span className="sr-only sm:not-sr-only sm:whitespace-nowrap">New Receipt</span>
          </Button>
        </div>
      </CardHeader>
      <CardContent>
